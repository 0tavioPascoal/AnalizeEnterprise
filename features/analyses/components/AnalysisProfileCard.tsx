      ...
      <div className="relative z-10 p-6">
        <div className="mb-6 flex flex-col gap-5 border-b border-border/45 pb-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex min-w-0 items-start gap-4">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-primary/15 bg-primary/10 text-xl font-black text-primary shadow-sm transition-transform duration-300 hover:scale-105">
...
function InfoPill({
  ...
  return (
    <div className="inline-flex max-w-full items-center gap-2 rounded-xl border border-border/50 bg-background/50 px-3.5 py-2 text-xs font-bold text-foreground">
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p
            className={cn(
              "mt-1 break-words text-sm font-bold leading-6",
              highlight
                ? "text-violet-700 dark:text-violet-300"
                : "text-foreground",
            )}
