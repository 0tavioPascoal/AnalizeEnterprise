...
import type {
  StatusBadgeProps,
  StatusVariant,
} from "@/types/layout/filters/StatusBadgeProps";
...
const variantClasses: Record<StatusVariant, string> = {
  ...
  info: "border-indigo-500/20 bg-indigo-500/10 text-indigo-700 hover:bg-indigo-500/10 dark:text-indigo-300",
...
export function StatusBadge({
  ...
  return (
    <Badge
      className={cn(
        "rounded-lg border px-2.5 py-1 text-xs font-bold shadow-none",
